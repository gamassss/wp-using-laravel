...
<div class="wrapper">
  ...
  <div id="sidebar">
    ...
    <ul class="list-unstyled component m-0">
      ...
      <li class="{{ ( Request::is('doctor/resep') || $data === 'Detail Resep' ) ? 'active' : '' }}">
        ...
        @endif 
          ...
          <div class="row">
            ...
            <div class="table-wrapper">
              ...
              <p><b>Nama Resep :</b> <span>{{ $recipe->nama_resep }}</span></p>
              <p><b>Detail Resep : </b> <span>{{ $recipe->detail_resep }}</span></p>
              <p><b>Tanggal resep dibuat : </b><span>{{ $recipe->tgl_resep }}</span></p>
